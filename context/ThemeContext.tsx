...
export const THEME_BACKGROUNDS = {
  cyberpunk: require('../assets/images/cyberpunk_bg.jpg'),
  electric_blue: require('../assets/images/electric_bg.jpg'),
  morning_forest: require('../assets/images/forest_bg.jpg'),
  solar_flare: require('../assets/images/solar_bg.jpg'),
  vaporwave: require('../assets/images/vaporwave_bg.jpg'),
  minimal_snow: require('../assets/images/snow_bg.jpg'),
